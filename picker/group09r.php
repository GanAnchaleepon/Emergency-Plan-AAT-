...
// --- Configuration ---
$current_group_name = "GROUP 09R"; // กำหนดกลุ่มสำหรับหน้านี้
...
/**
 * จัดรูปแบบหมายเลข Rotation ให้เป็น 4 หลักสำหรับการแสดงผล (1 -> 0001)
 * ไม่เปลี่ยนข้อมูลดิบที่ใช้กับฐานข้อมูลหรือ QR Code
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $task) {
    ...
    if ($submitted_step === $current_step) {
        ...
        header("Location: group09r.php?group=" . urlencode($current_group_name));
        exit;
    } else {
