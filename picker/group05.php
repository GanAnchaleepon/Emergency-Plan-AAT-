...
// --- Configuration ---
$current_group_name = "GROUP 05"; // กำหนดกลุ่มสำหรับหน้านี้
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $task) {
    ...
    if ($submitted_step === $current_step) {
        ...
        header("Location: group05.php?group=" . urlencode($current_group_name));
        exit;
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <?php if ($task && $current_step !== 'group_complete' && $current_step !== 'display_summary'): ?>
            ...
            <?php if (!$is_dummy_part): ?>
                <!-- Modern Scan Form with Step Progress (4 steps) -->
