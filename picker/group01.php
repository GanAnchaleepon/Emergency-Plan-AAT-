...
// --- Configuration ---
$current_group_name = "GROUP 01"; // กำหนดกลุ่มสำหรับหน้านี้
...
function formatRotation($rotation) {
    // ใช้ intval เพื่อป้องกันช่องว่างหรือศูนย์นำหน้าที่ไม่จำเป็นก่อนแปลง
    ...
    if ($submitted_step === $current_step) {
        ...
        switch ($current_step) {
            case 'scan_part_number':
                // ลบขีดออกจากข้อมูลที่สแกนและแปลงเป็นตัวพิมพ์ใหญ่
            ...
            case 'scan_item_lot':
                ...
                // เพิ่มการตรวจสอบความยาว 12 ตัวอักษร (นับ space ด้วย)
        ...
        header("Location: group01.php?group=" . urlencode($current_group_name));
        exit;
    } else {
