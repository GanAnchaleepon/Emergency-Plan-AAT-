...
// --- Configuration ---
$current_group_name = "GROUP 07"; // กำหนดกลุ่มสำหรับหน้านี้ // เปลี่ยนจาก "GROUP 03" เป็น "GROUP 07"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $task) {
    ...
    if ($submitted_step === $current_step) {
        ...
        header("Location: group07.php?group=" . urlencode($current_group_name)); // เปลี่ยนจาก group03.php เป็น group07.php
        exit;
    } else {
