...
// --- Configuration ---
$current_group_name = "GROUP 04"; // กำหนดกลุ่มสำหรับหน้านี้ // เปลี่ยนจาก "GROUP 02" เป็น "GROUP 04"
    ...
    if ($submitted_step === $current_step) {
        ...
        switch ($current_step) {
            ...
            case 'scan_item_lot':
                ...
                // เงื่อนไขพิเศษ: ถ้าเป็น Part 14401 ให้จำกัดความยาว 12 ตัวอักษร
                elseif (strpos($task['part_number'], '14401') !== false && strlen($scanned_data) !== 12) {
                    $_SESSION['error_message'] = 'Lot สินค้าสำหรับ Part 14401 ต้องมี 12 ตัวอักษรเท่านั้น';
                }
                else {
        ...
        header("Location: group04.php?group=" . urlencode($current_group_name)); // เปลี่ยนจาก group02.php เป็น group04.php
        exit;
    } else {
