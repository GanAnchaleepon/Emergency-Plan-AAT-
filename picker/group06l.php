...
// --- Configuration ---
$current_group_name = "GROUP 06L"; // กำหนดกลุ่มสำหรับหน้านี้
    ...
    if ($submitted_step === $current_step) {
        ...
        switch ($current_step) {
            case 'scan_part_number':
                ...
                // ตรวจสอบว่าข้อมูลที่สแกนขึ้นต้นด้วย Part Number ของระบบหรือไม่
                if (strpos($scanned_part_number_cleaned, $system_part_number_cleaned) === 0) {
            ...
            case 'scan_item_lot':
                ...
                if (preg_match('/^G\d{2,3}[LR]?_\d{6}/', $scanned_data)) {
            ...
            case 'scan_rotation_label':
                ...
                // ลบ 'R' ตัวเดียวถัดจาก 'G' ที่ขึ้นต้น (เช่น GR01_... -> G01_..., GR06R_... -> G06R_...)
        ...
        header("Location: group06l.php?group=" . urlencode($current_group_name));
        exit;
    } else {
            ...
            <div class="scan-form-container">
                ...
                <form method="POST" action="" id="scanForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12 mb-4">
                            <div class="step-card <?php echo $current_step === 'scan_rotation_label' ? 'active' : ($current_step !== 'scan_rotation_label' && $current_step !== 'scan_part_number' && $current_step !== 'scan_item_lot' && $current_step !== 'no_task' && $current_step !== 'display_summary' && $current_step !== 'group_complete' ? 'completed' : ''); ?>" 
                                 data-step="3">
                                <h4>
                                ...
                                <div class="form-group mb-0">
                                    <input type="text" 
                                           ...
                                           placeholder="สแกน Rotation Label..."
                                ...
                                <div class="mt-2">
                                    <small class="text-primary">
                                        <i class="fas fa-info-circle"></i> สแกน QR Code Rotation
                                    </small>
                                </div>
                                <?php endif; ?>
                            </div>
